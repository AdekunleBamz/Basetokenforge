...
export function WrongNetworkBanner() {
  ...
  return (
    <div 
      className="fixed top-0 left-0 right-0 z-[100] bg-gradient-to-r from-red-600 to-red-500 text-white py-3 px-4 shadow-lg"
      role="alert"
      aria-live="assertive"
    >
      <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-3">
        ...
        <button
          ...
          className="flex-shrink-0 bg-white text-red-600 px-5 py-2.5 rounded-xl font-semibold hover:bg-white/90 transition-all hover:scale-105 active:scale-95 flex items-center gap-2 shadow-lg"
        >
