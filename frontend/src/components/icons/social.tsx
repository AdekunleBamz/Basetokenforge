/**
 * Additional icon components - Part 2
 */
...
export function IconGas({ className = '', size = 24 }: IconProps) {
  return (
    <svg
      className={className}
      width={size}
    ...
    >
      ...
      <path d="M15 22V10a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2v12" />
      <path d="M3 10h12" />
      <path d="M19 6v3" />
    </svg>
  );
...
export function IconLightning({ className = '', size = 24 }: IconProps) {
  return (
    <svg
      className={className}
      width={size}
...
export function IconDiscord({ className = '', size = 24 }: IconProps) {
  return (
    <svg
      className={className}
      width={size}
